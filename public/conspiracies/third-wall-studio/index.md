...
The homepage carries two lines. We make animations with filmmakers and artists. We build new tech for ancient magic.

The pitch to collaborators is longer. You have a story. We have the studio. Third Wall works with writers, animators, directors, and visual artists who want to push into new territory, where live action, animation, and generative AI collapse into something that didn’t exist before. You bring the vision. Projects are co-produced, credit is shared, and the work stays yours. What the studio offers is access to generative AI tools and production pipelines, creative direction and mentorship, co-production with shared credit and shared risk, and a studio environment to develop work that doesn’t fit anywhere else yet.

On this site I put it this way. We mix live action, animation, and generative AI in the same production, not as a gimmick, but as part of the craft. And: Writers, animators, directors, and visual artists bring their own worlds. Burlap is the canvas underneath it all.

## How it started

I founded it in May 2025. We make animations with filmmakers and artists, and build new tech for ancient magic.

The credit: Sarth Calhoun founded Third Wall Studio in May 2025 and builds Burlap, the app its films are made in.
...
[*Through the Brambles*](/transmissions/through-the-brambles/), directed by [Jacob McCoy](/conspirators/jacob-mccoy/), is a VR story built entirely inside Burlap. Every scene began as a prompted 360° image, then became part of a single journey for headset playback. Gemini made the stills, Veo brought them to life, ElevenLabs handled narration, and Resolve held the edit and ambisonic mix. It is also at [thirdwallstudio.com/through-the-brambles](https://www.thirdwallstudio.com/through-the-brambles).

## Conspiracies

[Burlap](/conspiracies/burlap/) is the studio’s own tool and has its own page. The films are on [Work](/work/) and under Optical on [Transmissions](/transmissions/). How the studio prompts is written up in [Visual Reference Prompting](/transmissions/visual-reference-prompting/). The studio is on [Instagram](https://www.instagram.com/3rdwallstudio/) and [YouTube](https://www.youtube.com/@burlap_app).

The studio’s copy is from [thirdwallstudio.com](https://thirdwallstudio.com) and the sarth.net homepage. The film list is the one on [Work](/work/).
