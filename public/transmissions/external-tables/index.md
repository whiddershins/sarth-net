...
1. [Why append-only](/transmissions/external-tables/why-append-only/)
2. [Building on external tables](/transmissions/external-tables/building-on-external-tables/)
3. [Current truth with window functions](/transmissions/external-tables/current-truth-with-window-functions/)
4. [Defending the boundary](/transmissions/external-tables/defending-the-boundary/)
5. [Living with the code](/transmissions/external-tables/living-with-the-code/)
